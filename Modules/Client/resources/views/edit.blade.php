        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="client_name" id="name" class="form-control" value="{{ old('client_name', $client->client_name) }}" required>
                    @error('client_name')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="facility_level" id="facility_level" class="form-control" required>
                        ...
                        <option value="HCI" {{ old('facility_level', $client->facility_level) == 'HCI' ? 'selected' : '' }}>HCI</option>
                        <option value="HCII" {{ old('facility_level', $client->facility_level) == 'HCII' ? 'selected' : '' }}>HCII</option>
                        <option value="HCIII" {{ old('facility_level', $client->facility_level) == 'HCIII' ? 'selected' : '' }}>HCIII</option>
                        <option value="HCIV" {{ old('facility_level', $client->facility_level) == 'HCIV' ? 'selected' : '' }}>HCIV</option>
                        <option value="Referral Hospital" {{ old('facility_level', $client->facility_level) == 'Referral Hospital' ? 'selected' : '' }}>Referral Hospital</option>
                        <option value="Clinic" {{ old('facility_level', $client->facility_level) == 'Clinic' ? 'selected' : '' }}>Clinic</option>
                        <option value="Hospital" {{ old('facility_level', $client->facility_level) == 'Hospital' ? 'selected' : '' }}>Hospital</option>
                    </select>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="amount" id="amount" class="form-control" value="{{ old('amount', $client->amount) }}" step="0.01" required>
                    @error('amount')
                        <div class="alert alert-danger" role="alert">{{ $message }}</div>
                    @enderror
                </div>
